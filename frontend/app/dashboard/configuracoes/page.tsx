  ...
  return (
    <div className="animate-fade-up max-w-5xl">
      ...
      <section className="card-pad mt-4">
        ...
        <p className="mt-2 text-xs leading-relaxed text-ink-muted"><strong>Use o token emitido para a API Morfeu.</strong> Uma senha, hash ou chave obtida em outro produto/integração da Jettax — por exemplo, Jettax 360 ou Domínio/Onvio — não é comprovadamente compatível. Não existe geração autoatendimento de token Morfeu no painel do Jettax 360: o valor é emitido pela Jettax (suporte/comercial) junto com o acesso à API. Se o teste retornar 401 ou 403, peça à Jettax a confirmação do token Morfeu ativo e das permissões contratadas. Depois do teste bem-sucedido, cadastre cada empresa por CNPJ na tela Empresas.</p>
      </section>

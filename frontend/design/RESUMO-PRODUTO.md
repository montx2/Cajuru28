...
- **Espera correta:** janela SEFAZ e cStat 656 são âmbar, com tempo de retomada. Antecipar consulta é explicitamente desencorajado.
- **Falhas acionáveis:** toda mensagem informa ocorrência, causa provável e próximo passo. Rede, vazio, zero e carregamento não compartilham representação.
- **Acesso universal:** HTML semântico, foco forte, alvo mínimo, reflow, redução de movimento, contraste e diálogos com foco controlado são parte da arquitetura.

## Remoções

Saem gradientes, brilhos, desfoque decorativo, cartões elevados, ícones em bolhas, pesos 700/800, rótulos de 10 px, animação global de páginas, rodapé operacional, selo redundante de automação, confirmações nativas, ações órfãs e qualquer cor sem significado. Cards deixam de ser a unidade universal: tabelas e listas assumem os acervos; cartões ficam para decisões e agrupamentos curtos.
